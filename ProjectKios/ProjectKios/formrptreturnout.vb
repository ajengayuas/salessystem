...
Public Class formrptreturnout
    ...
    Private _myBusObj As x.DataRptReturnOut()
    ...
    Private Sub isiLap()
        _myBusObj = _mySrv.AmbilDataReturnOut(_secure, tgl1.Value, tgl2.Value)
        _rptDoc.Load("F:\KIOS\ProjectKios\ProjectKios\rptreturnout.rpt")
