...
Public Class formrptpengeluaran
    ...
    Private _myBusObj As x.DataRptPenjualan()
    ...
    Private Sub isiLap()
        _myBusObj = _mySrv.AmbilDataPenjualan(_secure, tgl1.Value, tgl2.Value)
        _rptDoc.Load("F:\KIOS\ProjectKios\ProjectKios\rptpengeluaran.rpt")
