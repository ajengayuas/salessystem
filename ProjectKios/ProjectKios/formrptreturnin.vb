...
Public Class formrptreturnin
    ...
    Private _myBusObj As x.DataRptReturnIn()
    ...
    Private Sub isiLap()
        _myBusObj = _mySrv.AmbilDataReturnIn(_secure, tgl1.Value, tgl2.Value)
        _rptDoc.Load("F:\KIOS\ProjectKios\ProjectKios\rptreturnin.rpt")
