...
Public Class penjualanmanual
    ...
    'Private Sub nudharga_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '    If nudharga.Enabled = True Then
    '        If nudharga.Value = 0 Then
    ...
    'Private Sub cbmulti_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    '    If cbmulti.Checked = True Then
    '        cmbitem.Enabled = False
