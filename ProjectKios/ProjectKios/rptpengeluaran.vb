...
Public Class rptpengeluaran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProjectKios.rptpengeluaran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptpengeluaran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptpengeluaran = New rptpengeluaran()
        rpt.Site = Me.Site
        Return rpt
    End Function
